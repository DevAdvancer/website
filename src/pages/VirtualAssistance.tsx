  ...
  const services = [
    {
      ...
      description:
        "From managing calendars, emails, and documents to handling data entry, CRM updates, and client follow-ups — we take care of the time-consuming tasks so you don’t have to.",
      details: [
    ...
    },
    {
      ...
      description:
        "We provide friendly, timely, and professional customer support on your behalf — ensuring your clients feel valued and heard at every touchpoint. Support that speaks your brand’s language.",
      details: [
    ...
    },
    {
      ...
      description:
        "We manage your social media from content planning to publishing and engagement. Whether you're a small business owner or a growing brand, we ensure your voice is heard and your audience stays connected.",
      details: [
    ...
    },
    {
      ...
      description:
        "We help businesses identify, reach, and engage with potential clients through strategic outreach and follow-up. From list building to initial outreach and appointment setting, we handle the heavy lifting so your sales team can focus on closing deals.",
      details: [
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Streamline your operations with our professional virtual
                assistance services. Focus on what matters most while we handle
        ...
        <Container>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Professional virtual assistance services designed to improve
              efficiency and reduce operational overhead.
            </p>
          </div>
        ...
        <Container>
          <div className="text-center">
            ...
            <p className="text-lg opacity-90 mb-8 max-w-2xl mx-auto">
              Discover how our virtual assistance services can help you focus on
